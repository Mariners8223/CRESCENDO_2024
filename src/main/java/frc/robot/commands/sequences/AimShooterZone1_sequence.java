...
public class AimShooterZone1_sequence extends SequentialCommandGroup {
  /** Creates a new AimShooterZone1_sequence. */
  public AimShooterZone1_sequence() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new InstantCommand(() -> Shooter.getInstance().setShooterPower(0.8)),
      new ParallelCommandGroup(new AimShooterZone1(),
