...
import frc.util.armabot.lidar.impl.errors.Timeout;
import frc.util.armabot.lidar.impl.vl53l0x.errors.NoSpadInfo;

import java.util.Optional;

import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.DYNAMIC_SPAD_NUM_REQUESTED_REF_SPAD;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.DYNAMIC_SPAD_REF_EN_START_OFFSET;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.GLOBAL_CONFIG_REF_EN_START_SELECT;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.GLOBAL_CONFIG_SPAD_ENABLES_REF_0;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.GPIO_HV_MUX_ACTIVE_HIGH;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.MSRC_CONFIG_CONTROL;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.SYSTEM_INTERRUPT_CLEAR;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.SYSTEM_INTERRUPT_CONFIG_GPIO;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.SYSTEM_SEQUENCE_CONFIG;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.VHV_CONFIG_PAD_SCL_SDA__EXTSUP_HV;
