...
import frc.util.armabot.lidar.api.Error;
import frc.util.armabot.lidar.api.Vl6180x;
import frc.util.armabot.lidar.arcompat.PololuI2c;
import frc.util.armabot.lidar.arcompat.Port;
import frc.util.armabot.lidar.impl.errors.IncorrectModelId;
...
import static frc.util.armabot.lidar.impl.vl6180x.Calculations.constrain;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.I2C_SLAVE__DEVICE_ADDRESS;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.IDENTIFICATION__MODEL_ID;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.INTERLEAVED_MODE__ENABLE;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.RANGE_SCALER;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.READOUT__AVERAGING_SAMPLE_PERIOD;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.RESULT__ALS_VAL;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.RESULT__INTERRUPT_STATUS_GPIO;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.RESULT__RANGE_VAL;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSALS__ANALOGUE_GAIN;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSALS__INTEGRATION_PERIOD;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSALS__INTERMEASUREMENT_PERIOD;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSALS__START;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSRANGE__CROSSTALK_VALID_HEIGHT;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSRANGE__INTERMEASUREMENT_PERIOD;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSRANGE__MAX_CONVERGENCE_TIME;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSRANGE__PART_TO_PART_RANGE_OFFSET;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSRANGE__RANGE_CHECK_ENABLES;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSRANGE__START;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSRANGE__VHV_RECALIBRATE;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSRANGE__VHV_REPEAT_RATE;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSTEM__FRESH_OUT_OF_RESET;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSTEM__INTERRUPT_CLEAR;
import static frc.util.armabot.lidar.impl.vl6180x.Vl6180xReg.SYSTEM__INTERRUPT_CONFIG_GPIO;
import static frc.util.armabot.lidar.util.Preconditions.checkArgument;
import static frc.util.armabot.lidar.util.Preconditions.checkState;
