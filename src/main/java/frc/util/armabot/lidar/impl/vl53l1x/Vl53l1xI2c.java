...
package frc.util.armabot.lidar.impl.vl53l1x;

import frc.util.armabot.lidar.api.Error;
import frc.util.armabot.lidar.api.Vl53l1x;
...
import frc.util.armabot.lidar.arcompat.Wire;

import java.util.Objects;
import java.util.Optional;
import java.util.concurrent.TimeUnit;

import static frc.util.armabot.lidar.impl.vl53l1x.Calculations.calcMacroPeriod;
import static frc.util.armabot.lidar.impl.vl53l1x.Calculations.decodeTimeout;
import static frc.util.armabot.lidar.impl.vl53l1x.Calculations.encodeTimeout;
import static frc.util.armabot.lidar.impl.vl53l1x.Calculations.timeoutMclksToMicroseconds;
import static frc.util.armabot.lidar.impl.vl53l1x.Calculations.timeoutMicrosecondsToMclks;
