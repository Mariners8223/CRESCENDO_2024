...
package frc.util.armabot.lidar.impl.vl53l0x;

import frc.util.armabot.lidar.api.Error;
import frc.util.armabot.lidar.api.Vl53l0x;
...
import static frc.util.armabot.lidar.impl.vl53l0x.Calculations.calcMacroPeriod;
import static frc.util.armabot.lidar.impl.vl53l0x.Calculations.decodeVcselPeriod;
import static frc.util.armabot.lidar.impl.vl53l0x.Calculations.encodeVcselPeriod;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.ALGO_PHASECAL_CONFIG_TIMEOUT;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.ALGO_PHASECAL_LIM;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.FINAL_RANGE_CONFIG_MIN_COUNT_RATE_RTN_LIMIT;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.FINAL_RANGE_CONFIG_TIMEOUT_MACROP_HI;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.FINAL_RANGE_CONFIG_VALID_PHASE_HIGH;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.FINAL_RANGE_CONFIG_VALID_PHASE_LOW;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.FINAL_RANGE_CONFIG_VCSEL_PERIOD;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.GLOBAL_CONFIG_VCSEL_WIDTH;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.MSRC_CONFIG_TIMEOUT_MACROP;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.OSC_CALIBRATE_VAL;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.PRE_RANGE_CONFIG_TIMEOUT_MACROP_HI;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.PRE_RANGE_CONFIG_VALID_PHASE_HIGH;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.PRE_RANGE_CONFIG_VALID_PHASE_LOW;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.PRE_RANGE_CONFIG_VCSEL_PERIOD;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.RESULT_INTERRUPT_STATUS;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.RESULT_RANGE_STATUS;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.SYSRANGE_START;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.SYSTEM_INTERMEASUREMENT_PERIOD;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.SYSTEM_INTERRUPT_CLEAR;
import static frc.util.armabot.lidar.impl.vl53l0x.Vl53l0xReg.SYSTEM_SEQUENCE_CONFIG;
